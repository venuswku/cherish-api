...
const actionSchema = new Schema({
  ...
  description: { type: String, required: true },                             // explanation for act of kindness
  ...
  imageLink: { type: String },                                               // link to an image that relates to this act of kindness (optional field)
}, {
